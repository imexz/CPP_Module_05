...
/*   Updated: 2022/02/03 01:55:54 by mstrantz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Form.hpp"

Form::Form(void) :  _name("unknown"), _signed(false), _gradeReq(150), _gradeExe(150){

}

Form::Form(const std::string name, const unsigned int gradeReq, const unsigned int gradeExe) :
	_name(name), _signed(false), _gradeReq(gradeReq), _gradeExe(gradeExe) {
